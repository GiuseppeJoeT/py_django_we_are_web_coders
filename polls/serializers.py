...
'''
This is how we are going to define which models are included in our website
services.

The ModelSerializer knows which members are available, and will automate the
process without you having to define what they should be.
'''
